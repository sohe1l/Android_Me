...
public class BodyPartFragment extends Fragment {
    ...
    private static final String image_list_tag = "image_list";
    private static final String image_index_tag = "image_index";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            mListIndex = savedInstanceState.getInt(image_index_tag);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(image_index_tag, mListIndex);
    }
}
